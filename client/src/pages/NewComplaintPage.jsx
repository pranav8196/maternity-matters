...
const NewComplaintPage = () => {
  ...
  const initialFormData = {
    complainantName: '', complainantContact: '', complainantEmail: '',
    companyName: '', companyAddress: '', dateOfJoining: '',
    numberOfSurvivingChildren: '0', expectedDeliveryDate: '', actualDeliveryDate: '',
    issuesFaced: [], additionalInputs: '', supportingDocumentsInfo: '',
        ...
        {isSubmitted ? (
            ...
            <>
                ...
                <form onSubmit={handleSubmit} noValidate>
                    <div className={currentStep === 1 ? 'block' : 'hidden'}><FormStep>
                      <div>
                    ...
                    <div className={currentStep === 2 ? 'block' : 'hidden'}><FormStep>
                      <div>
                    ...
                    <div className={currentStep === 3 ? 'block' : 'hidden'}><FormStep>
                      <div>
                    ...
                    <div className={currentStep === 4 ? 'block' : 'hidden'}><FormStep>
                      <div>
                    ...
                    <div className="flex justify-between items-center pt-6">
                        <div>
                        {currentStep > 1 && (
                            <button type="button" onClick={handlePrev} className="px-6 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors shadow-sm">
                            Back
                            </button>
                        )}
                        </div>
                        ...
                        {currentStep < totalSteps && (
                            <button type="button" onClick={handleNext} className="px-6 py-2 bg-brand-primary hover:bg-brand-primary-hover text-white font-semibold rounded-lg shadow-md">
                            Next
                            </button>
                        )}
                        {currentStep === totalSteps && (
